...
final class HomeRenovationLogUITests: XCTestCase {
    ...
    func testAddItemFlow() {
        ...
        let field1 = app.textFields["fieldProjectName"]
        XCTAssertTrue(field1.waitForExistence(timeout: 2))
        field1.tap()
        field1.typeText("Test Project Name")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["Test Project Name"].waitForExistence(timeout: 2))
    }
